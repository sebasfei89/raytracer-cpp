...
SCENARIO("Matrix equality with equal matrices", "math")
{
    GIVEN( Mat44 const a({
            { 1.0f,  2.0f,  3.0f,  4.0f},
            { 5.0f,  6.0f,  7.0f,  8.0f},
...
SCENARIO("Matrix equality with different matrices", "math")
{
    GIVEN( Mat44 const a({
            {1.0f, 2.0f, 3.0f, 4.0f},
            {5.0f, 6.0f, 7.0f, 8.0f},
...
SCENARIO("Transposing the identity matrix", "math")
{
    GIVEN( Mat44 const identity({
            {1.f, 0.f, 0.f, 0.f},
            {0.f, 1.f, 0.f, 0.f},
            {0.f, 0.f, 1.f, 0.f},
            {0.f, 0.f, 0.f, 1.f} }) )
    WHEN( Mat44 i = identity;
        , i.Transpose() )
    THEN( i == identity )
}
...
SCENARIO("Calculating a minor of a 3x3 matrix", "math")
{
    GIVEN( Mat33 const m({
            ...
            {2.f,-1.f,-7.f},
            {6.f,-1.f, 5.f} }) )
    THEN( m.Submatrix(1, 0).Determinant() == 25.f
        , m.Minor(1, 0) == 25.f )
}
...
SCENARIO("Testing a matrix for invertibility", "math")
{
    GIVEN( Mat44 const m({
            ...
            {4.f,-9.f, 3.f,-7.f},
            {9.f, 1.f, 7.f,-6.f} }) )
    THEN( m.Determinant() == -2120
        , m.IsInvertible() )
}

SCENARIO("Testing a matrix for invertibility with non-invertible matrix", "math")
{
    GIVEN( Mat44 const m({
            {-4.f, 2.f,-2.f,-3.f},
            { 9.f, 6.f, 2.f, 6.f},
