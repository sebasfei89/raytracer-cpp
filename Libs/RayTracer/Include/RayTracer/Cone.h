...
protected:
    ...
    void EarlyTest(Ray const& ray, float a, std::vector<Intersection>& xs) const override;
    bool EarlyTestBefore(Ray const& ray, float a, float distance) const override;
};
