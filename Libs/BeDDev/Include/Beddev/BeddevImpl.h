...
#define BEDDEV_FE_16(WHAT, X, ...) BEDDEV_EXPAND( WHAT(X)BEDDEV_FE_15(WHAT, __VA_ARGS__))
#define BEDDEV_FE_17(WHAT, X, ...) BEDDEV_EXPAND( WHAT(X)BEDDEV_FE_16(WHAT, __VA_ARGS__))
#define BEDDEV_FE_18(WHAT, X, ...) BEDDEV_EXPAND( WHAT(X)BEDDEV_FE_17(WHAT, __VA_ARGS__))
#define BEDDEV_FE_19(WHAT, X, ...) BEDDEV_EXPAND( WHAT(X)BEDDEV_FE_18(WHAT, __VA_ARGS__))
#define BEDDEV_FE_20(WHAT, X, ...) BEDDEV_EXPAND( WHAT(X)BEDDEV_FE_19(WHAT, __VA_ARGS__))

#define BEDDEV_GET_MACRO(_1, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11, _12, _13, _14, _15, _16, _17, _18, _19, _20, NAME, ...) NAME
#define BEDDEV_FOREACH(action, ...) BEDDEV_EXPAND( BEDDEV_GET_MACRO(__VA_ARGS__, BEDDEV_FE_20, BEDDEV_FE_19, BEDDEV_FE_18, BEDDEV_FE_17, BEDDEV_FE_16, BEDDEV_FE_15, BEDDEV_FE_14, BEDDEV_FE_13, BEDDEV_FE_12, BEDDEV_FE_11, BEDDEV_FE_10, BEDDEV_FE_9, BEDDEV_FE_8, BEDDEV_FE_7, BEDDEV_FE_6, BEDDEV_FE_5, BEDDEV_FE_4, BEDDEV_FE_3, BEDDEV_FE_2, BEDDEV_FE_1)(action, __VA_ARGS__) )
// END BEDDEV_FOREACH
